  ...
  return (
    <div className="w-full pb-24 pt-16 relative">
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card/90 backdrop-blur-md border border-border rounded-xl overflow-hidden mb-16 shadow-lg">
          {/* HEADER BAR */}
          ...
          <div className="p-10 text-center">
            ...
            <div className="flex items-center justify-center gap-16 mt-10 font-mono">
              ...
              <div className="flex flex-col items-center">
                <p className="text-3xl font-bold text-primary">3min</p>
                <p className="text-sm text-muted-foreground uppercase tracking-wide mt-1">
                  Creation Time
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {USER_PROGRAMS.map((program) => (
            <Card
              key={program.id}
              className="bg-card/90 backdrop-blur-md border border-border hover:border-primary/50 transition-colors overflow-hidden shadow-md"
            >
